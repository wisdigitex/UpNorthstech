...
I build modern websites, bots & automation systems that help businesses grow and scale.
</p>

<div className="flex gap-5 flex-wrap mb-10">
<a href="/request" className="bg-orange-500 px-8 py-5 rounded-2xl text-black font-bold">
Hire Me
</a>

<a href="/projects" className="border border-white/10 px-8 py-5 rounded-2xl">
View My Work
</a>
</div>
...
<img src="https://randomuser.me/api/portraits/men/32.jpg" className="w-14 h-14 rounded-full border-2 border-[#050816]" />
<img src="https://randomuser.me/api/portraits/women/45.jpg" className="w-14 h-14 rounded-full border-2 border-[#050816]" />
<img src="https://randomuser.me/api/portraits/men/64.jpg" className="w-14 h-14 rounded-full border-2 border-[#050816]" />
</div>

<div>
<h3 className="text-orange-400 font-bold text-lg">50+ Happy Clients</h3>
...
Full-stack developer specialized in websites, trading bots, automation systems and premium user experiences.
</p>

<div className="grid sm:grid-cols-2 gap-5">
<div className="bg-white/5 border border-white/10 rounded-3xl p-6">
<h3 className="text-orange-400 font-bold mb-3">Experience</h3>
<p>5+ Years</p>
</div>

<div className="bg-white/5 border border-white/10 rounded-3xl p-6">
<h3 className="text-orange-400 font-bold mb-3">Location</h3>
...
<div className="bg-white/5 border border-white/10 rounded-[30px] px-10 py-8 flex flex-wrap items-center justify-center gap-12 text-gray-300">
<span>Airbnb</span>
<span>PayPal</span>
<span>Binance</span>
<span>Coinbase</span>
...
<button className="bg-orange-500 px-6 py-3 rounded-xl text-black font-bold">
View Project
</button>
...
UpNorth Tech delivered an amazing dashboard and trading system. Excellent communication and premium quality.
</p>
...
<div className="bg-white/5 border border-white/10 rounded-[32px] p-10 text-left">
<p className="text-gray-300 leading-8 mb-8">
Great design, smooth animations and responsive development. Highly recommended for modern projects.
</p>
...
<a href="/blog" className="text-orange-400 font-bold">
View All Posts →
</a>
...
Modern development article and premium insights.
</p>
...
<button
type="submit"
className="w-full bg-orange-500 py-5 rounded-2xl text-black font-black hover:scale-[1.02] transition"
>
Send Request
</button>
